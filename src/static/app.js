document.addEventListener("DOMContentLoaded", () => {
  ...
  function displayFilteredActivities() {
    ...
    // Apply client-side filtering - this handles category filter, search, weekend filter, and difficulty filter
    ...
    Object.entries(allActivities).forEach(([name, details]) => {
      ...
      // Apply difficulty filter - "All" shows only activities without difficulty field
      if (currentDifficulty === "") {
        // "All" option - show only activities without a difficulty field
        if (details.difficulty) {
          return;
        }
      } else {
        // Specific difficulty selected - show only matching activities
